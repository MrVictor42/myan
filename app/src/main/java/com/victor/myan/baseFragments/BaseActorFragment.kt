...
class BaseActorFragment : Fragment() {

    private lateinit var binding : FragmentBaseActorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBaseActorBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
